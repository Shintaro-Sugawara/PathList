...
LABELS = {
    "ja": {
        "APP_TITLE": "Path List",
        "MSG_DROP_FOLDER": "このアイコン上にフォルダをドロップしてください。",
    ...
    "de": {
        "APP_TITLE": "Path List",
        "MSG_DROP_FOLDER": "Bitte ziehen Sie einen Ordner auf dieses Symbol.",
    ...
    "en": {
        "APP_TITLE": "Path List",
        "MSG_DROP_FOLDER": "Please drop a folder onto this icon.",
        "MSG_INTRO": "A list will be created on your desktop.",
